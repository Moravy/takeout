...
def update_order(request):
    ...
    if data['action'] == "add":
        ...
        new_cart_item = Cart(menu=menu, restaurant=restaurant,
    ...
    # order item from cart and delete item from cart
        ...
        for item in all_cart_items:
            ...
            new_order = Order(menu=item.menu, restaurant=item.restaurant,
                              customer=request.user.customer)
            new_order.save()
        return redirect("customer_cart")
    ...
    # Changing order status
        ...
        for i in list_of_order:
            ...
            order_status = Order.objects.get(customer=customer,
                                             menu=menu)
